  ...
  componentDidMount() {
    this.setPage(() => {
      if (!this.state.locale) {
        this.setLocale(localStorage.getItem('ESSENCE_LANGUAGE') || 'zh-CN');
      }
    });
  }
    ...
    if (routes) {
      if (locales.hasOwnProperty(routes[1])) {
        this.setState({ locale: routes[1] }, () => {
          localStorage.setItem('ESSENCE_LANGUAGE', this.state.locale);
        });
      }
        ...
        <footer className="footer">
          <div className="container">
            <div className="footer-main">
              <p className="footer-main-title">Essence-React</p>
              <a href="https://github.com/essencemike/Essence/issues" target="_blank" rel="noopener noreferrer" className="footer-main-link">{this.getLocale('misc.feedback')}</a>
              <a href="https://github.com/essencemike/blob/master/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer" className="footer-main-link">{this.getLocale('misc.contribution')}</a>
            </div>
            <div className="footer-social">
              <a href="https://github.com/essencemike/Essence" target="_blank" rel="noopener noreferrer">
